class ManagementOrder
  ...
  attr_accessor :postal_code, :prefecture_id, :municipality, :address, :building, :telephone_number, :management_id, :user_id,
                :item_id, :token
  ...
  def save
    ...
    Order.create(postal_code: postal_code, prefecture_id: prefecture_id, municipality: municipality, address: address,
                 building: building, telephone_number: telephone_number, management_id: management.id)
  end
end
